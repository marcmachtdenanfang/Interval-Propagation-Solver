...
public class WeirdTest {
    ...
    @Test
    public void mulContractionTest01UpdateMethod()
    {
        // Setup.
        ...
        var y1 = res.get("y");
        var z1 = res.get("z");
        System.out.println("mulContractionTest01UpdateMethod");
    ...
    @Test
    public void addContractionTest6UpdateMethod()
    {
        // Setup.
        Interval x = new Interval("x", 20, 1, true, true);
        Interval y = new Interval("y", 0, 10, true, true);
        ...
        // Method that actually gets tested.
        ctx.update();
        System.out.println(ctx.varIntervals.get("x") + ":" + ctx.varIntervals.get("x").getClass());
